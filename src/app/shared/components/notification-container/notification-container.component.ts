...
import { NotificationService, NotificationType } from '../../services/notificacion.service';
...
export class NotificationContainerComponent implements OnInit, OnDestroy {
  ...
  getNotificationIcon(type: NotificationType): string {
    switch (type) {
      ...
      case 'error':
        return `<svg class="w-5 h-5 text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
